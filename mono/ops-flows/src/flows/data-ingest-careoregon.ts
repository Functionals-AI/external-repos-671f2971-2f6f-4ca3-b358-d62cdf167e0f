...
import { CareOregon } from '@mono/ops/lib/data'
import OpsTasks from '../tasks/ingest'

const SOURCE = 'careoregon'
...
const SRC_PREFIX = 'careoregon/inbound/'
const FILE_PREFIX = 'CareOregon_FoodSmart_'
      ...
      return {
        ...
        states: {
          [State.Ingest]: OpsTasks.ingest({
            flowName: FLOW_NAME,
            sourceId: SOURCE,
            ingestFunction: CareOregon.ingest,
            next: State.Success
          }),
