  ...
  if (variant === 'default') {
    return (
      <svg
        ...
        viewBox="0 0 16 16"
        fill="none"
        className={cn('border-neutral-200', props.className)}
      >
  ...
  if (variant === 'disallowed') {
    return (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 16 16"
        className={cn('fill-neutral-115', props.className)}
      >
  ...
  if (variant === 'checked') {
    return (
      <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
        <rect height="100%" width="100%" rx="8" className="fill-fs-green-200" />
        <circle cx="8" cy="8" r="3" fill="white" />
      </svg>
    );
  }
