#!/bin/bash
echo "Running DBMATE migrations in DEV..."
...
AWS_PROFILE=dev aws ecs run-task \
	--launch-type FARGATE \
	--cluster OpsStore \
	--network-configuration '{"awsvpcConfiguration":{"subnets":["subnet-a6c709ef"],"securityGroups":["sg-00c798f7d54f2d898"],"assignPublicIp":"DISABLED"}}' \
