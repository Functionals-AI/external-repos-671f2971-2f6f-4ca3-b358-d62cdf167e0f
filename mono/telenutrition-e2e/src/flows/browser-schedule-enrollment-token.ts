...
const MTAG = [ 'telenutrition-e2e', 'flows', 'browser-schedule-enrollment-token' ]

enum State {
  E2ESchedulingEnrollmentToken = 'E2ESchedulingEnrollmentToken',
  Success = 'Success'
}
...
export default workflow(function (config) {
  return {
    rate: '1 day',
    startAt: State.E2ESchedulingEnrollmentToken,
    states: {
      [State.E2ESchedulingEnrollmentToken]: schedule({
        verificationMethod: E2EScheduleVerificationMethods.EnrollmentToken,
        next: State.Success
      }),
